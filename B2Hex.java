...
//    static Queue2 myqueue2 = new Queue2(20);
    ...
    public static void groupings(String a, ArrayList<String> groups , Queue2 myqueue1)
    {
        String value = a;
    ...
    public static void printhex(String a , Queue2 myqueue1){
    ...
    public static void fracgroupings(String a , ArrayList<String> chunks , Queue2 myqueue2){
...
// Pad to make length a multiple of 4
    ...
    public static void printfrachex(String a , Queue2 myqueue2){
