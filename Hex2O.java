...
public class Hex2O {
    ...
    public static void inthex(String a , ArrayList<String> groups ,ArrayList<String> groups2, Queue3 myqueue1)
    {
        String value = a;
        String finalout ="";
...
//System.out.println(finalout);
        B2O.groupings(finalout,groups2,myqueue1);
    }



    public static void frachex(String a , ArrayList<String> chunks ,ArrayList<String> chunks2, Queue3 myqueue2){
...
//System.out.println(finalout);
        B2O.fracgroupings(finalout,chunks2,myqueue2);
    }
