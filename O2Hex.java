...
public class O2Hex {
  ...
  static B2Hex binary2hex = new B2Hex();

public static void inthex(String a)
{
    String value = a;
    String finalout ="";
...
binary2hex.groupings(finalout);
}



public static void frachex(String a){
...
binary2hex.fracgroupings(finalout);
}
    ...
    public static void main(String[] args) {
        ...
        binary2hex.printhex(parts[0]);
        System.out.print(".");
        binary2hex.printfrachex(parts[1]);
