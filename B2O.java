...
public class B2O {
    ...
    public static void groupings(String a , ArrayList<String> groups , Queue3 myqueue1)
    {
        String value = a;
    ...
    public static void printhex(String a , Queue3 myqueue1){
    ...
    public static void fracgroupings(String a , ArrayList<String> chunks , Queue3 myqueue2){
...
// Pad to make length a multiple of 4
    ...
    public static void printfrachex(String a , Queue3 myqueue2){
